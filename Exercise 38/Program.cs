    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (exitCondition)
            {
                ...
                Console.WriteLine(AvgOfArray(5));
        ...
        public static string AvgOfArray(int num)
        {
            ...
            return $"({stringSum.Remove(stringSum.Length - 3)})/5 = {sum/5}";  // calculate average and output calculation as string
